...
HOLDINGS: list[Holding] = [
    ...
    Holding("IRCTC",                    "IRCTC.NS",       3,   545.1, "stock"),  
    Holding("ITC",                      "ITC.NS",        21,   374.3, "stock"),  
    Holding("PFC",                      "PFC.NS",        19,  361.42, "stock"), 
    Holding("Power Grid Corporation",   "POWERGRID.NS",   4,  263.88, "stock"),  
    Holding("REC Ltd",                  "RECLTD.NS",     19,   352.8, "stock"),  
    Holding("Tata Power",               "TATAPOWER.NS",   4,  368.47, "stock"),  
    Holding("Wonderla Holidays",        "WONDERLA.NS",    3,   495.9, "stock"),  
    ...
    Holding("Nippon India GoldBees",      "GOLDBEES.NS", 53,   103.7, "etf"),   
    Holding("ICICI Silver ETF",         "SILVERIETF.NS",  3,  218.24, "etf"),   
    Holding("Kotak Nifty IT ETF",       "IT.NS",         10,    31.9, "etf"),   
    Holding("Motital Oswal Nasdaq 100 ETF","MON100.NS",   5,  226.22, "etf"),   
    Holding("Hang Seng BeES",           "HNGSNGBEES.NS",  3,  509.44, "etf"),   
]
